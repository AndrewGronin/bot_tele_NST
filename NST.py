...
class NST(nn.Module):
    def __init__(self, imsize=256):
        ...
        self.cnn_normalization_mean_default = torch.tensor([0.485, 0.456, 0.406]).to(self.device)
        self.cnn_normalization_std_default = torch.tensor([0.229, 0.224, 0.225]).to(self.device)
